...
public interface ClientProtocol extends VersionedProtocol { //JobClient 和 JobTracker用于通信，JobClient 可以用里面的方法去提交一个job,获取系统状态
  /* 
  ...
  /**
   * Allocate a name for the job. 分配名字
  ...
  /** 
   * Get all blacklisted trackers in cluster.  @@http://blog.csdn.net/liangliyin/article/details/7606275, hadoop的黑名单机制
   * @return array of TaskTrackerInfo
   */
   ...
   * where job-specific files are to be placed.   获取提交路径
   * 
  ...
  /**
   * Gets set of Queues associated with the Job Tracker @@ http://li.angshan.blog.163.com/blog/static/1313322892012617451545/
   * 
  ...
  /**
   * Gets scheduling information associated with the particular Job queue @@http://li.angshan.blog.163.com/blog/static/1313322892012617451545/
   * 
  ...
  /**
   * Gets the Queue ACLs for current user             acl= access control list
